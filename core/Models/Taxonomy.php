 ...
 * @method static TaxonomyQueryBuilder paginateArchive( int $postsPerPage = 10 )
 * @method static TaxonomyQueryBuilder wherePostType( $postTypes = 'post' )
 * @method static TaxonomyQueryBuilder whereTerm( string $key, $value, $operator = 'IN' )
 * @method static TaxonomyQueryBuilder andWhereTerm( string $key, $value, string $operator = 'IN' )
 * @method static TaxonomyQueryBuilder orWhereTerm( string $key, $value, string $operator = 'IN' )
